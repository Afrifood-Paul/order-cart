    ...
    <div className="relative group border-4 border-white p-6 cursor-pointer ">
      <div className="overflow-hidden aspect-w-1 aspect-h-1">
        <img
          ...
          className="object-cover w-full h-full bg-black py-6 px-4 rounded-2xl transition-all duration-300 group-hover:scale-125"
        />
      </div>

      <div className="flex flex-col md:flex-row items-start justify-between mt-4 space-x-4">
        <div className="font-bold text-gray-300 sm:text-sm md:text-lg">
          <p className="w-[100px] overflow-hidden text-ellipsis whitespace-nowrap">
            {singleProductTitle.title}
          </p>
        </div>
        <div className="text-right">
          <p className="text-xs font-bold text-gray-300 sm:text-sm md:text-[14px]">
